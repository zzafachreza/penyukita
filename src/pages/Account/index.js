                    ...
                    <>
                        ...
                        <View style={{
                            ...
                            <View style={{ padding: 10, }}>
                                <MyList label="Nama Lengkap Ibu" value={user.nama_ibu} />
                                <MyList label="Nama Lengkap Ayah" value={user.nama_ayah} />
                                <MyList label="Nama Lengkap Anak" value={user.nama_anak} />
                                <MyList label="Telepon / Whatsapp" value={user.telepon} />

                                <MyList label="Kecamatan" value={user.kelurahan} />
