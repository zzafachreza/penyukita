    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyInput label="Nama Lengkap Ibu" iconname="person-outline" value={kirim.nama_ibu} onChangeText={x => setKirim({ ...kirim, nama_ibu: x })} />
                <MyGap jarak={5} />
                <MyInput label="Nama Lengkap Ayah" iconname="person-outline" value={kirim.nama_ayah} onChangeText={x => setKirim({ ...kirim, nama_ayah: x })} />
                <MyGap jarak={5} />
                <MyInput label="Nama Lengkap Anak" iconname="person-outline" value={kirim.nama_anak} onChangeText={x => setKirim({ ...kirim, nama_anak: x })} />
                <MyGap jarak={5} />
                ...
                <MyGap jarak={5} />
                <MyInput label="Kelurahan" placeholder="masukan kelurahan" multiline iconname="home-outline" value={kirim.kelurahan} onChangeText={x => setKirim({ ...kirim, kelurahan: x })} />
